...
public class ABPBoilerplateTesteTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<ABPBoilerplateTesteTenantDatabaseMigrationHandler> _logger;

    public ABPBoilerplateTesteTenantDatabaseMigrationHandler(
        ABPBoilerplateTesteDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<ABPBoilerplateTesteTenantDatabaseMigrationHandler> logger)
    {
